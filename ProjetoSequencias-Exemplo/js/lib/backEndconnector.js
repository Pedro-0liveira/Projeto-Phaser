...
function getTOP(di, df, globalCodTurma, globalCodEscola,scene) {
    ...
    ({
        ...
        data: "action=mostraNew&anoLi=" + di + "&anoLf=" + df + "&mturma=" + globalCodTurma + "&mescola=" + globalCodEscola + "&flag=2" + "&tip=1"  + "&tC=sequenciasTOP",
        crossDomain: true,
        cache: false,
        success: function (response) {
            data = [];
...
function updateTOP(di, df, globalCodTurma, globalCodEscola,flag,scene) {
    ...
    ({
        type: "POST",
        url: "https://www.hypatiamat.com/newHRecords.php",
        data: "action=mostraNew&anoLi=" + di + "&anoLf=" + df + "&mturma=" + globalCodTurma + "&mescola=" + globalCodEscola + "&flag="+flag  + "&tip=1"+ "&tC=sequenciasTOP",
        crossDomain: true,
        cache: false,
        success: function (response) {
            data = [];
...
function verificaRecords(username, globalCodTurma, globalCodEscola, pontuacao,scene) {
    ...
    ({
        type: "POST",
        url: "https://www.hypatiamat.com/newHRecords.php",
        data: "action=maximoGlobal&codAl=" + username + "&codTurma=" + globalCodTurma + "&codEscola=" + globalCodEscola + "&pont=" + pontuacao  + "&tip=1" + "&t=sequenciasHypatia&tC=sequenciasTOP",
        crossDomain: true,
        cache: false,
        success: function (response) {
            var data = []       
...
function gravaRecords(username, globalCodTurma, globalCodEscola, pontuacao) {
    ...
    ({
        type: "POST",
        url: "https://www.hypatiamat.com/newHRecords.php",
        data: "action=insere&musername=" + username + "&mturma=" + globalCodTurma + "&mescola=" + globalCodEscola + "&mpontuacao=" + pontuacao + "&mtipo=1" + "&t=sequenciasHypatia&tC=sequenciasTOP",
        crossDomain: true,
        cache: false,
        success: function (response) {
        },
...
function getRecords(username, globalCodTurma, globalCodEscola, scene) {
    ...
    ({
        type: "POST",
        url: "https://www.hypatiamat.com/newHRecords.php",
        data: "action=minimoGlobal&codAl=" + username + "&codTurma=" + globalCodTurma + "&codEscola=" + globalCodEscola + "&pont=" + 0 + "&tip=1" + "&t=sequenciasHypatia&tC=sequenciasTOP",
        crossDomain: true,
        cache: false,
        success: function (response) {
